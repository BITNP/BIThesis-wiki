...
::: warning 对应 CTAN 上的 v2.0.0
此版本在 CTAN 发布了公告 [CTAN update: bithesis](https://www.ctan.org/ctan-ann/id/mailman.2543.1649489263.3195.ctan-ann@ctan.org)，正文如下，附注版本号为 2.0.0 2022-04-01。

> Add support for the master thesis.

2026年4月回顾 CTAN 记录时发现，[该版本`bithesis.dtx`](https://svn.tug.org:8369/texlive/trunk/Master/texmf-dist/source/latex/bithesis/bithesis.dtx?pathrev=62980&view=markup)对应[`v2.2.0-4-1-g2627834`](https://github.com/BITNP/BIThesis/commit/2627834188d97ebdcc99006e79e56fe1495f098b)。因此，CTAN 上的 v2.0.0 恐怕标串了版本，实际内容其实介于 v2.2.0-4 与 v2.2.1 之间，更接近 v2.2.0-4。
:::
